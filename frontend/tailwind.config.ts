...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        'soft': '0 2px 10px -2px rgba(0,0,0,0.03), 0 4px 20px -4px rgba(0,0,0,0.05)',
        'medium': '0 4px 16px -2px rgba(0,0,0,0.05), 0 8px 30px -4px rgba(0,0,0,0.08)',
        'large': '0 8px 24px -4px rgba(0,0,0,0.06), 0 16px 40px -8px rgba(0,0,0,0.1)',
        'glow-blue': '0 0 20px -4px rgba(59,130,246,0.2)',
        'glow-green': '0 0 20px -4px rgba(16,185,129,0.2)',
        'glow-amber': '0 0 20px -4px rgba(245,158,11,0.2)',
        'card-hover': '0 12px 32px -8px rgba(0,0,0,0.08), 0 24px 64px -16px rgba(0,0,0,0.05)',
